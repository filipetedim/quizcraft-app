...
class AddQuestion extends Component {
  ...
  addQuestion = () => {
    ...
    QuestionService.postQuestion({ expansion, difficulty, type, category, question, answer, wrong })
      .then(() => {
        setTimeout(() => {
          History.push('/');
      ...
      .catch(error => {
        setTimeout(() => {
          this.setState({ loading: false, error: error.body.validationErrors, wrong: [] });
        }, Config.SPINNER_TIME);
      });
  };
